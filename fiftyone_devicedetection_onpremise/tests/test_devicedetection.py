...
class DeviceDetectionTests(unittest.TestCase):
    ...
    def test_mass_user_agent_processing_results(self):
        """!
        Test the 20,000 user agent process results are correct
        """

        pipeline = DeviceDetectionOnPremisePipelineBuilder(
            data_file_path=data_file, usage_sharing=False, licence_keys="", performance_profile='MaxPerformance',
    ...
    def test_benchmark_low_memory(self):
        """!
        Benchmark using low_memory 
        """

        pipeline = DeviceDetectionOnPremisePipelineBuilder(
            data_file_path=data_file, usage_sharing=False, licence_keys="", performance_profile='LowMemory',
            add_javascript_builder=False,
            restricted_properties=["ismobile"]).build()
    ...
    def test_benchmark_high_performance(self):
        """!
        Benchmark using high performance
        """

        pipeline = DeviceDetectionOnPremisePipelineBuilder(
            data_file_path=data_file, usage_sharing=False, licence_keys="", performance_profile='HighPerformance',
            add_javascript_builder=False,
            restricted_properties=["ismobile"]).build()
    ...
    def test_benchmark_balanced(self):
        ...
        pipeline = DeviceDetectionOnPremisePipelineBuilder(
            data_file_path=data_file, usage_sharing=False, licence_keys="", performance_profile='Balanced',
            add_javascript_builder=False,
            restricted_properties=["ismobile"]).build()
    ...
    #     """!
    #     Benchmark using in memory datafile 
    #     """
    #     with open(data_file,'rb') as f:
    #         output = f.read()

    #     pipeline = DeviceDetectionOnPremisePipelineBuilder(
    #         data=output, usage_sharing=False, licence_keys="", performance_profile='Balanced',
    #         add_javascript_builder=False,
    #         restricted_properties=["ismobile"]).build()
