...
if resource_key == "!!YOUR_RESOURCE_KEY!!":
    ...
    make sure to include the HardwareName, HardwareProfile, HardwareVendor and Profiles
    ...
    flowdata.evidence.add('query.nativemodel', native_model_android)
    ...
    print("Which devices are associated with the native model name: " + native_model_android) 
